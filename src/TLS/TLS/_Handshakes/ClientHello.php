...
class ClientHello extends Handshake{
  ...
  public function __construct(Version $version = Version::TLS_10, ?string $session_id = null){
  ...
  public function addExtension(Extension ...$extensions): void{
    foreach($extensions as $extension){
      ...
      if($extension->getType() === ExtensionType::UNKNOWN){
        continue;
      }
  ...
  public static function decode(string $data): self{
    ...
    $client_hello->version = Version::from($data->getU16());
